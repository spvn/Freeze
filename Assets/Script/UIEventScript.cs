...
public class UIEventScript : MonoBehaviour {
	...
	void OnTriggerEnter(Collider other) {
		if (other.gameObject.layer == 9) {
			...
			case "jump":
				Debug.Log("Entered");
				canvasEventText.GetComponent<Text>().text = "JUMP: X";
				break;
			case "move":
				Debug.Log("Moved");
				...
				break;
			case "pulse":
				canvasEventText.GetComponent<Text>().text = "PULSE: B";
				break;
			case "strafe":
				canvasEventText.GetComponent<Text>().text = "STRAFE: LEFT/RIGHT AXIS";
				break;
			case "deflect":
